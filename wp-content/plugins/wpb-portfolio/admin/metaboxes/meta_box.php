		...
		function wpb_fp_custom_meta_box_field( $field, $meta = null, $repeatable = null ) {
			...
			switch( $type ) {
				...
				case 'shortcode':
					...
					$shortcode_value = '['.$default_value.''.$shortcode_title.' id="'.$post->ID.'"]';
				...
				case 'gallery':
					...
					echo '<div class="wpb-field-gallery">';
						...
						$add    = __( 'Add Gallery', WPB_FP_TEXTDOMAIN );
					    $edit   = __( 'Edit Gallery', WPB_FP_TEXTDOMAIN );
					    $clear  = __( 'Clear', WPB_FP_TEXTDOMAIN );
