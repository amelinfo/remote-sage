<?php
  $tm = '<section class="testimonials-list slider-one">' . "\n";
  ...
  $tm .= '<div class="testimonials-content"><blockquote class="quote-card '.$color.'-card">' . apply_filters('the_content', get_the_content()) . '</blockquote></div>' . "\n";
...
$tm .= '</ul>' . "\n";
$tm .= '</section>' . "\n";   
$tm .= '<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>';
