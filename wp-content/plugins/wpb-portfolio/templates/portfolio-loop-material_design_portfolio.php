...
if( $wpb_fp_link_full_grid_type == 'details_page' ){
	...
	$link_full_grid 			= '<a data-post-id="' . esc_attr( $post->ID ) . '" class="wpb-fp-portfolio-link wpb_fp_preview open-popup-link" href="#" data-effect="'. esc_attr( $wpb_fp_popup_effect ) .'">+</a>';
}
?>
