        ...
        $settings_fields = array( 
            ...
            'wpb_fp_advanced' => array(
                array(
                    ...
                    'default'   => 'mixitup',
                    'options'   => array(
                        'mixitup'   => __( 'Mixitup', WPB_FP_TEXTDOMAIN ),
                        'isotope'   => __( 'Isotope', WPB_FP_TEXTDOMAIN ),
                    )
                ),
                array(
            ...
            'wpb_fp_style' => array(
                ...
                array(
                    ...
                    'desc'      => __( 'Select an effect for mouse hover on portfolio. ( only for skin hover effect )', WPB_FP_TEXTDOMAIN ),
                    'type'      => 'select',
                ...
                array(
                    ...
                    'desc'      => __( 'Select a style for portfolio filter. ( We recommend not to use the Select Box. )', WPB_FP_TEXTDOMAIN ),
                    'type'      => 'select',
                    'default'   => 'default',
                    'options'   => array(
                        'default'     => 'Default',
